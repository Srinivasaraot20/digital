export default function Process() {
  const steps = [
    ...
    },
    {
      ...
      cardIcon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M9 3v18"/><path d="M15 3v18"/><path d="M3 9h18"/><path d="M3 15h18"/></svg>
      )
    },
    {
      num: "03",
      ...
      class: "step-purple",
      circleIcon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/><path d="M9 12H4s.55-3.03 2-4.5c1.4-1.4 4.5-2 4.5-2"/><path d="M12 15v5s3.03-.55 4.5-2c1.4-1.4 2-4.5 2-4.5"/></svg>
      ),
      cardIcon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="12" x="3" y="4" rx="2" ry="2"/><line x1="2" y1="20" x2="22" y2="20"/><line x1="12" y1="16" x2="12" y2="20"/></svg>
      )
    },
    {
      num: "04",
      ...
      cardIcon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/><path d="M22 12A10 10 0 0 0 12 2v10z"/></svg>
      )
    },
    {
      num: "05",
  ...
  return (
    <section className="process">
      <div className="sec-header" style={{ marginBottom: "36px" }}>
        <div style={{ display: "inline-flex", background: "rgba(245,107,0,0.06)", color: "#ff6b00", fontSize: "11px", fontWeight: 700, padding: "5px 12px", borderRadius: "20px", marginBottom: "16px", textTransform: "uppercase", letterSpacing: "0.5px", alignItems: "center", gap: "6px" }}>
          ⚙️ OUR PROCESS
        </div>
        <h2 style={{ fontSize: "36px", fontWeight: "850", color: "#0f172a" }}>
          How We <span style={{ color: "#ff6b00" }}>Work</span>
        </h2>
        <p style={{ fontSize: "15px", color: "#64748b", maxWidth: "600px", margin: "12px auto 0", lineHeight: "1.6" }}>
      ...
      <div className="process-steps-container">
        ...
        <div className="process-steps">
          {steps.map((step, idx) => (
            <div className={`proc-step-card-wrap ${step.class}`} key={idx}>
              <div className="proc-circle">
                {step.circleIcon}
              </div>
              <div className="proc-card">
                <span className="proc-step-badge">STEP {step.num}</span>
                <h3>{step.title}</h3>
                <p>{step.desc}</p>
      ...
      <div className="process-trust-bar">
        <div className="trust-item">
          <div className="trust-icon-box" style={{ background: "rgba(245, 107, 0, 0.08)", color: "#ff6b00" }}>
          ...
          <div className="trust-info">
            <h4>Goal-Oriented</h4>
            <p>Every step aligned with your business goals</p>
          </div>
        </div>
        <div className="trust-item">
          <div className="trust-icon-box" style={{ background: "rgba(236, 72, 153, 0.08)", color: "#ec4899" }}>
          ...
          <div className="trust-info">
            <h4>Data-Driven</h4>
            <p>Decisions backed by real-time insights</p>
          </div>
        </div>
        <div className="trust-item">
          <div className="trust-icon-box" style={{ background: "rgba(139, 92, 246, 0.08)", color: "#8b5cf6" }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
          </div>
          <div className="trust-info">
            <h4>Agile & Transparent</h4>
            <p>Continuous updates and clear communication</p>
          </div>
        </div>
        <div className="trust-item">
          <div className="trust-icon-box" style={{ background: "rgba(16, 185, 129, 0.08)", color: "#10b981" }}>
          ...
          <div className="trust-info">
            ...
            <p>Driving measurable growth and maximum ROI</p>
          </div>
        </div>
      </div>
    </section>
